...
SERVICE_NAME = app
CONTAINER_NAME = data-preparation-container

DIRS_TO_VALIDATE = mehmet
...
## Call entrypoint
prepare-dataset: up
	$(DOCKER_COMPOSE_EXEC) python ./mehmet/prepare_dataset.py

## Processes raw data
process-data: up
	$(DOCKER_COMPOSE_EXEC) python ./mehmet/process_data.py
