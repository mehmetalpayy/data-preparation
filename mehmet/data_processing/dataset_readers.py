...
from mehmet.utils.utils import get_logger
...
class DatasetReader(ABC):
    ...
    def _read_data(self) -> tuple[dd.core.DataFrame, dd.core.DataFrame, dd.core.DataFrame]:
        ...
        Returns:
            tuple[dd.core.DataFrame, dd.core.DataFrame, dd.core.DataFrame]
        """
    ...
    def split_dataset(self, 
        ...
        unique_columns_values = df[stratify_column].unique()
        first_dfs = []
        second_dfs = []
        for unique_set_value in unique_columns_values:
...
class GHCDataReader(DatasetReader):
    def __init__(self, dataset_dir: str, dataset_name: str, dev_split_ratio: float):
        super().__init__(dataset_dir=dataset_dir, dataset_name=dataset_name)
